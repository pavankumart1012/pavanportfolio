...
if st.session_state.page == "About Me":
    ...
    - Able to build and deploy machine learning models for different applications.
    - Experienced in using scikit-learn, TensorFlow, and Keras.
    - Familiar with various machine learning techniques such as regression, classification, and clustering.
    - Able to perform model evaluation and tuning.
    """)
